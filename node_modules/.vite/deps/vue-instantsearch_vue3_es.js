...
function _objectSpread5(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys5(Object(source), true).forEach(function(key) {
...
function _objectSpread6(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys6(Object(source), true).forEach(function(key) {
...
function _objectSpread7(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys7(Object(source), true).forEach(function(key) {
...
function _objectSpread8(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys8(Object(source), true).forEach(function(key) {
...
function _objectSpread9(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys9(Object(source), true).forEach(function(key) {
...
function _objectSpread10(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys10(Object(source), true).forEach(function(key) {
...
function p2(n5, i4, t6, r15, o7) {
  var f8 = { type: n5, props: i4, key: t6, ref: r15, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == o7 ? ++u : o7 };
  return null == o7 && null != l.vnode && l.vnode(f8), f8;
}
function _(n5) {
  return n5.children;
}
function k(n5, l7, u10, i4, t6) {
  var r15;
  for (r15 in u10)
    "children" === r15 || "key" === r15 || r15 in l7 || g(n5, r15, null, u10[r15], i4);
  for (r15 in l7)
    t6 && "function" != typeof l7[r15] || "children" === r15 || "key" === r15 || "value" === r15 || "checked" === r15 || u10[r15] === l7[r15] || g(n5, r15, l7[r15], u10[r15], i4);
}
function b(n5, l7, u10) {
  "-" === l7[0] ? n5.setProperty(l7, null == u10 ? "" : u10) : n5[l7] = null == u10 ? "" : "number" != typeof u10 || a2.test(l7) ? u10 : u10 + "px";
}
function g(n5, l7, u10, i4, t6) {
  var r15;
  n:
    if ("style" === l7)
      if ("string" == typeof u10)
        ...
        if ("string" == typeof i4 && (n5.style.cssText = i4 = ""), i4)
          for (l7 in i4)
            u10 && l7 in u10 || b(n5.style, l7, "");
        if (u10)
          for (l7 in u10)
            i4 && u10[l7] === i4[l7] || b(n5.style, l7, u10[l7]);
      }
    else if ("o" === l7[0] && "n" === l7[1])
      r15 = l7 !== (l7 = l7.replace(/Capture$/, "")), l7 = l7.toLowerCase() in n5 ? l7.toLowerCase().slice(2) : l7.slice(2), n5.l || (n5.l = {}), n5.l[l7 + r15] = u10, u10 ? i4 || n5.addEventListener(l7, r15 ? w : m, r15) : n5.removeEventListener(l7, r15 ? w : m, r15);
    else if ("dangerouslySetInnerHTML" !== l7) {
      if (t6)
        l7 = l7.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
      else if ("width" !== l7 && "height" !== l7 && "href" !== l7 && "list" !== l7 && "form" !== l7 && "tabIndex" !== l7 && "download" !== l7 && l7 in n5)
        try {
          n5[l7] = null == u10 ? "" : u10;
          break n;
        } catch (n6) {
        }
      "function" == typeof u10 || (null == u10 || false === u10 && -1 == l7.indexOf("-") ? n5.removeAttribute(l7) : n5.setAttribute(l7, u10));
    }
}
function m(n5) {
  t3 = true;
  try {
    return this.l[n5.type + false](l.event ? l.event(n5) : n5);
  } finally {
    t3 = false;
  }
}
function w(n5) {
  t3 = true;
  try {
    return this.l[n5.type + true](l.event ? l.event(n5) : n5);
  } finally {
    t3 = false;
  }
}
...
function A(n5, l7) {
  if (null == l7)
    return n5.__ ? A(n5.__, n5.__.__k.indexOf(n5) + 1) : null;
  for (var u10; l7 < n5.__k.length; l7++)
    if (null != (u10 = n5.__k[l7]) && null != u10.__e)
      return u10.__e;
  return "function" == typeof n5.type ? A(n5) : null;
}
function P(n5) {
  var l7, u10;
...
function C(n5) {
  t3 ? setTimeout(n5) : f(n5);
}
function T(n5) {
  (!n5.__d && (n5.__d = true) && r.push(n5) && !$.__r++ || o2 !== l.debounceRendering) && ((o2 = l.debounceRendering) || C)($);
}
function $() {
  var n5, l7, u10, i4, t6, o7, f8, e7;
  for (r.sort(function(n6, l8) {
    return n6.__v.__b - l8.__v.__b;
  }); n5 = r.shift(); )
    n5.__d && (l7 = r.length, i4 = void 0, t6 = void 0, f8 = (o7 = (u10 = n5).__v).__e, (e7 = u10.__P) && (i4 = [], (t6 = h2({}, o7)).__v = o7.__v + 1, M(e7, o7, t6, u10.__n, void 0 !== e7.ownerSVGElement, null != o7.__h ? [f8] : null, i4, null == f8 ? A(o7) : f8, o7.__h), N(i4, o7), o7.__e != f8 && P(o7)), r.length > l7 && r.sort(function(n6, l8) {
      return n6.__v.__b - l8.__v.__b;
    }));
  $.__r = 0;
}
function H(n5, l7, u10, i4, t6, r15, o7, f8, e7, a10) {
  var h5, v5, y3, d4, k3, b2, g4, m6 = i4 && i4.__k || s, w2 = m6.length;
  for (u10.__k = [], h5 = 0; h5 < l7.length; h5++)
    if (null != (d4 = u10.__k[h5] = null == (d4 = l7[h5]) || "boolean" == typeof d4 ? null : "string" == typeof d4 || "number" == typeof d4 || "bigint" == typeof d4 ? p2(null, d4, null, null, d4) : Array.isArray(d4) ? p2(_, { children: d4 }, null, null, null) : d4.__b > 0 ? p2(d4.type, d4.props, d4.key, d4.ref ? d4.ref : null, d4.__v) : d4)) {
      if (d4.__ = u10, d4.__b = u10.__b + 1, null === (y3 = m6[h5]) || y3 && d4.key == y3.key && d4.type === y3.type)
        m6[h5] = void 0;
      else
        for (v5 = 0; v5 < w2; v5++) {
          if ((y3 = m6[v5]) && d4.key == y3.key && d4.type === y3.type) {
            m6[v5] = void 0;
            break;
          }
          y3 = null;
        }
      M(n5, d4, y3 = y3 || c, t6, r15, o7, f8, e7, a10), k3 = d4.__e, (v5 = d4.ref) && y3.ref != v5 && (g4 || (g4 = []), y3.ref && g4.push(y3.ref, null, d4), g4.push(v5, d4.__c || k3, d4)), null != k3 ? (null == b2 && (b2 = k3), "function" == typeof d4.type && d4.__k === y3.__k ? d4.__d = e7 = I(d4, e7, n5) : e7 = z(n5, d4, y3, m6, k3, e7), "function" == typeof u10.type && (u10.__d = e7)) : e7 && y3.__e == e7 && e7.parentNode != n5 && (e7 = A(y3));
    }
  for (u10.__e = b2, h5 = w2; h5--; )
    null != m6[h5] && ("function" == typeof u10.type && null != m6[h5].__e && m6[h5].__e == u10.__d && (u10.__d = L(i4).nextSibling), q(m6[h5], m6[h5]));
  if (g4)
    for (h5 = 0; h5 < g4.length; h5++)
      S(g4[h5], g4[++h5], g4[++h5]);
}
function I(n5, l7, u10) {
  for (var i4, t6 = n5.__k, r15 = 0; t6 && r15 < t6.length; r15++)
    (i4 = t6[r15]) && (i4.__ = n5, l7 = "function" == typeof i4.type ? I(i4, l7, u10) : z(u10, i4, i4, t6, i4.__e, l7));
  return l7;
}
function z(n5, l7, u10, i4, t6, r15) {
  var o7, f8, e7;
  if (void 0 !== l7.__d)
    o7 = l7.__d, l7.__d = void 0;
  else if (null == u10 || t6 != r15 || null == t6.parentNode)
    n:
      if (null == r15 || r15.parentNode !== n5)
        n5.appendChild(t6), o7 = null;
      else {
        for (f8 = r15, e7 = 0; (f8 = f8.nextSibling) && e7 < i4.length; e7 += 1)
          if (f8 == t6)
            break n;
        n5.insertBefore(t6, r15), o7 = r15;
      }
  return void 0 !== o7 ? o7 : t6.nextSibling;
}
function L(n5) {
  var l7, u10, i4;
  if (null == n5.type || "string" == typeof n5.type)
    return n5.__e;
  if (n5.__k) {
    for (l7 = n5.__k.length - 1; l7 >= 0; l7--)
      if ((u10 = n5.__k[l7]) && (i4 = L(u10)))
        return i4;
  }
  return null;
}
function M(n5, u10, i4, t6, r15, o7, f8, e7, c13) {
  var s6, a10, v5, y3, p5, d4, k3, b2, g4, m6, w2, A2, P2, C2, T2, $2 = u10.type;
  if (void 0 !== u10.constructor)
    return null;
  null != i4.__h && (c13 = i4.__h, e7 = u10.__e = i4.__e, u10.__h = null, o7 = [e7]), (s6 = l.__b) && s6(u10);
  try {
    n:
      if ("function" == typeof $2) {
        if (b2 = u10.props, g4 = (s6 = $2.contextType) && t6[s6.__c], m6 = s6 ? g4 ? g4.props.value : s6.__ : t6, i4.__c ? k3 = (a10 = u10.__c = i4.__c).__ = a10.__E : ("prototype" in $2 && $2.prototype.render ? u10.__c = a10 = new $2(b2, m6) : (u10.__c = a10 = new x(b2, m6), a10.constructor = $2, a10.render = B), g4 && g4.sub(a10), a10.props = b2, a10.state || (a10.state = {}), a10.context = m6, a10.__n = t6, v5 = a10.__d = true, a10.__h = [], a10._sb = []), null == a10.__s && (a10.__s = a10.state), null != $2.getDerivedStateFromProps && (a10.__s == a10.state && (a10.__s = h2({}, a10.__s)), h2(a10.__s, $2.getDerivedStateFromProps(b2, a10.__s))), y3 = a10.props, p5 = a10.state, a10.__v = u10, v5)
          null == $2.getDerivedStateFromProps && null != a10.componentWillMount && a10.componentWillMount(), null != a10.componentDidMount && a10.__h.push(a10.componentDidMount);
        else {
          if (null == $2.getDerivedStateFromProps && b2 !== y3 && null != a10.componentWillReceiveProps && a10.componentWillReceiveProps(b2, m6), !a10.__e && null != a10.shouldComponentUpdate && false === a10.shouldComponentUpdate(b2, a10.__s, m6) || u10.__v === i4.__v) {
            for (u10.__v !== i4.__v && (a10.props = b2, a10.state = a10.__s, a10.__d = false), u10.__e = i4.__e, u10.__k = i4.__k, u10.__k.forEach(function(n6) {
              n6 && (n6.__ = u10);
            }), w2 = 0; w2 < a10._sb.length; w2++)
              a10.__h.push(a10._sb[w2]);
            a10._sb = [], a10.__h.length && f8.push(a10);
            break n;
          }
          null != a10.componentWillUpdate && a10.componentWillUpdate(b2, a10.__s, m6), null != a10.componentDidUpdate && a10.__h.push(function() {
            a10.componentDidUpdate(y3, p5, d4);
          });
        }
        if (a10.context = m6, a10.props = b2, a10.__P = n5, A2 = l.__r, P2 = 0, "prototype" in $2 && $2.prototype.render) {
          for (a10.state = a10.__s, a10.__d = false, A2 && A2(u10), s6 = a10.render(a10.props, a10.state, a10.context), C2 = 0; C2 < a10._sb.length; C2++)
            a10.__h.push(a10._sb[C2]);
          a10._sb = [];
        } else
          do {
            a10.__d = false, A2 && A2(u10), s6 = a10.render(a10.props, a10.state, a10.context), a10.state = a10.__s;
          } while (a10.__d && ++P2 < 25);
        a10.state = a10.__s, null != a10.getChildContext && (t6 = h2(h2({}, t6), a10.getChildContext())), v5 || null == a10.getSnapshotBeforeUpdate || (d4 = a10.getSnapshotBeforeUpdate(y3, p5)), T2 = null != s6 && s6.type === _ && null == s6.key ? s6.props.children : s6, H(n5, Array.isArray(T2) ? T2 : [T2], u10, i4, t6, r15, o7, f8, e7, c13), a10.base = u10.__e, u10.__h = null, a10.__h.length && f8.push(a10), k3 && (a10.__E = a10.__ = null), a10.__e = false;
      } else
        null == o7 && u10.__v === i4.__v ? (u10.__k = i4.__k, u10.__e = i4.__e) : u10.__e = O(i4.__e, u10, i4, t6, r15, o7, f8, c13);
    (s6 = l.diffed) && s6(u10);
  } catch (n6) {
    u10.__v = null, (c13 || null != o7) && (u10.__e = e7, u10.__h = !!c13, o7[o7.indexOf(e7)] = null), l.__e(n6, u10, i4);
  }
}
function N(n5, u10) {
...
function O(l7, u10, i4, t6, r15, o7, f8, e7) {
  var s6, a10, h5, y3 = i4.props, p5 = u10.props, d4 = u10.type, _2 = 0;
  if ("svg" === d4 && (r15 = true), null != o7) {
    for (; _2 < o7.length; _2++)
      if ((s6 = o7[_2]) && "setAttribute" in s6 == !!d4 && (d4 ? s6.localName === d4 : 3 === s6.nodeType)) {
        l7 = s6, o7[_2] = null;
        break;
      }
  }
  if (null == l7) {
    ...
    l7 = r15 ? document.createElementNS("http://www.w3.org/2000/svg", d4) : document.createElement(d4, p5.is && p5), o7 = null, e7 = false;
  }
  if (null === d4)
    y3 === p5 || e7 && l7.data === p5 || (l7.data = p5);
  else {
    if (o7 = o7 && n4.call(l7.childNodes), a10 = (y3 = i4.props || c).dangerouslySetInnerHTML, h5 = p5.dangerouslySetInnerHTML, !e7) {
      if (null != o7)
        for (y3 = {}, _2 = 0; _2 < l7.attributes.length; _2++)
          y3[l7.attributes[_2].name] = l7.attributes[_2].value;
      (h5 || a10) && (h5 && (a10 && h5.__html == a10.__html || h5.__html === l7.innerHTML) || (l7.innerHTML = h5 && h5.__html || ""));
    }
    if (k(l7, p5, y3, r15, e7), h5)
      u10.__k = [];
    else if (_2 = u10.props.children, H(l7, Array.isArray(_2) ? _2 : [_2], u10, i4, t6, r15 && "foreignObject" !== d4, o7, f8, o7 ? o7[0] : i4.__k && A(i4, 0), e7), null != o7)
      for (_2 = o7.length; _2--; )
        null != o7[_2] && v(o7[_2]);
    e7 || ("value" in p5 && void 0 !== (_2 = p5.value) && (_2 !== l7.value || "progress" === d4 && !_2 || "option" === d4 && _2 !== y3.value) && g(l7, "value", _2, y3.value, false), "checked" in p5 && void 0 !== (_2 = p5.checked) && _2 !== l7.checked && g(l7, "checked", _2, y3.checked, false));
  }
  return l7;
}
function S(n5, u10, i4) {
  try {
...
function q(n5, u10, i4) {
  var t6, r15;
  if (l.unmount && l.unmount(n5), (t6 = n5.ref) && (t6.current && t6.current !== n5.__e || S(t6, null, u10)), null != (t6 = n5.__c)) {
  ...
  if (t6 = n5.__k)
    for (r15 = 0; r15 < t6.length; r15++)
      t6[r15] && q(t6[r15], u10, i4 || "function" != typeof n5.type);
  i4 || null == n5.__e || v(n5.__e), n5.__ = n5.__e = n5.__d = void 0;
}
function B(n5, l7, u10) {
  return this.constructor(n5, u10);
}
n4 = s.slice, l = { __e: function(n5, l7, u10, i4) {
  for (var t6, r15, o7; l7 = l7.__; )
    if ((t6 = l7.__c) && !t6.__)
      try {
        if ((r15 = t6.constructor) && null != r15.getDerivedStateFromError && (t6.setState(r15.getDerivedStateFromError(n5)), o7 = t6.__d), null != t6.componentDidCatch && (t6.componentDidCatch(n5, i4 || {}), o7 = t6.__d), o7)
          return t6.__E = t6;
      } catch (l8) {
        n5 = l8;
      }
...
}, t3 = false, x.prototype.setState = function(n5, l7) {
  var u10;
  u10 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = h2({}, this.state), "function" == typeof n5 && (n5 = n5(h2({}, u10), this.props)), n5 && h2(u10, n5), null != n5 && this.__v && (l7 && this._sb.push(l7), T(this));
}, x.prototype.forceUpdate = function(n5) {
  this.__v && (this.__e = true, n5 && this.__h.push(n5), T(this));
}, x.prototype.render = _, r = [], f = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, $.__r = 0, e3 = 0;
...
function _objectSpread11(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys11(Object(source), true).forEach(function(key) {
...
function _objectSpread12(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys12(Object(source), true).forEach(function(key) {
    ...
    return {
      ...
      getWidgetRenderState: function getWidgetRenderState(_ref5) {
        ...
        if (!results) {
          ...
          if (cachedHits[_page] === void 0 && !results.__isArtificial && instantSearchInstance.status === "idle") {
...
function _objectSpread13(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys13(Object(source), true).forEach(function(key) {
...
function _objectSpread14(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys14(Object(source), true).forEach(function(key) {
...
function _objectSpread15(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys15(Object(source), true).forEach(function(key) {
...
function _objectSpread16(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys16(Object(source), true).forEach(function(key) {
...
var _excluded22 = ["escapedValue", "value"];
...
function _objectSpread17(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys17(Object(source), true).forEach(function(key) {
          ...
          if (query === "" && lastItemsFromMainSearch) {
            ...
            helper.searchForFacetValues(
              ...
              var normalizedFacetValues = transformItems(facetValues.map(function(_ref3) {
                var escapedValue = _ref3.escapedValue, value = _ref3.value, item = _objectWithoutProperties5(_ref3, _excluded22);
                return _objectSpread17(_objectSpread17({}, item), {}, {
                  value: escapedValue,
                  label: value
                });
...
function _objectSpread18(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys18(Object(source), true).forEach(function(key) {
...
function _objectSpread19(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys19(Object(source), true).forEach(function(key) {
...
function _objectSpread20(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys20(Object(source), true).forEach(function(key) {
...
function _objectSpread21(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys21(Object(source), true).forEach(function(key) {
...
function _objectSpread22(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys22(Object(source), true).forEach(function(key) {
...
function _objectSpread23(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys23(Object(source), true).forEach(function(key) {
...
function _objectSpread24(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys24(Object(source), true).forEach(function(key) {
...
function _objectSpread25(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys25(Object(source), true).forEach(function(key) {
...
function _objectSpread26(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys26(Object(source), true).forEach(function(key) {
...
function _objectSpread27(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys27(Object(source), true).forEach(function(key) {
...
function _objectSpread28(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys28(Object(source), true).forEach(function(key) {
...
function _objectSpread29(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys29(Object(source), true).forEach(function(key) {
...
function _objectSpread30(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys30(Object(source), true).forEach(function(key) {
...
var connectAnswers = function connectAnswers2(renderFn) {
  ...
  return function(widgetParams) {
    ...
    if (!queryLanguages || queryLanguages.length === 0) {
      throw new Error(withUsage25("The `queryLanguages` expects an array of strings."));
    }
    ...
    return {
      ...
      init: function init(initOptions) {
        ...
        if (!hasFindAnswersMethod(answersIndex)) {
          throw new Error(withUsage25("`algoliasearch` >= 4.8.0 required."));
        }
      ...
      render: function render(renderOptions) {
        ...
        runConcurrentSafePromise(debouncedRefine(query, queryLanguages, _objectSpread30(_objectSpread30({}, extraParameters), {}, {
          nbHits,
          ...
          isLoading = false;
          debouncedRender(_objectSpread30(_objectSpread30({}, _this.getWidgetRenderState(renderOptions)), {}, {
            instantSearchInstance: renderOptions.instantSearchInstance
          }), false);
        });
      },
...
function _objectSpread31(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys31(Object(source), true).forEach(function(key) {
...
function _objectSpread32(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys32(Object(source), true).forEach(function(key) {
...
var connectDynamicWidgets = function connectDynamicWidgets2(renderFn) {
  ...
  return function(widgetParams) {
    ...
    if (!(widgets && Array.isArray(widgets) && widgets.every(function(widget) {
      return _typeof37(widget) === "object";
    }))) {
...
var d = createVNode("pre", null, "refine: Function", -1);
...
function c2(l7, c13, o7, m6, p5, v5) {
  return l7.state ? (openBlock(), createBlock("div", { key: 0, class: l7.suit() }, [renderSlot(l7.$slots, "default", { refine: l7.state.refine, currentRefinement: l7.state.currentRefinement, indices: l7.state.indices }, function() {
    return [s2, a3, d, createVNode("pre", null, 'currentRefinement: "' + toDisplayString(l7.state.currentRefinement) + '"', 1), createVNode("details", null, [f2, createVNode("pre", null, toDisplayString(l7.state.indices), 1)])];
...
function v2(o7, v5, L2, R, h5, d4) {
  return o7.state ? (openBlock(), createBlock("div", { key: 0, class: [o7.suit(), !o7.state.canRefine && o7.suit("", "noRefinement")] }, [renderSlot(o7.$slots, "default", { items: o7.state.items, canRefine: o7.state.canRefine, refine: o7.state.refine, createURL: o7.state.createURL }, function() {
    return [createVNode("ul", { class: o7.suit("list") }, [createVNode("li", { class: [o7.suit("item"), !o7.state.items.length && o7.suit("item", "selected")] }, [Boolean(o7.state.items.length) ? (openBlock(), createBlock("a", { key: 0, href: o7.state.createURL(), class: o7.suit("link"), onClick: v5[1] || (v5[1] = withModifiers(function(e7) {
      ...
      return openBlock(), createBlock("li", { key: i4.label, class: [o7.suit("item"), d4.isLastItem(r15) && o7.suit("item", "selected")] }, [createVNode("span", { class: o7.suit("separator"), "aria-hidden": "true" }, [renderSlot(o7.$slots, "separator", {}, function() {
        return [k2];
      })], 2), d4.isLastItem(r15) ? (openBlock(), createBlock("span", p3, toDisplayString(i4.label), 1)) : (openBlock(), createBlock("a", { key: 0, href: o7.state.createURL(i4.value), class: o7.suit("link"), onClick: withModifiers(function(e7) {
...
function u2(s6, u10, o7, c13, l7, d4) {
  return s6.state ? (openBlock(), createBlock("div", { key: 0, class: s6.suit() }, [renderSlot(s6.$slots, "default", { canRefine: d4.canRefine, refine: s6.state.refine, createURL: s6.state.createURL }, function() {
    return [createVNode("button", { type: "reset", class: [s6.suit("button"), !d4.canRefine && s6.suit("button", "disabled")], disabled: !d4.canRefine, onClick: u10[1] || (u10[1] = withModifiers(function() {
...
init_vue_runtime_esm_bundler();
function c5(c13, v5, f8, o7, m6, d4) {
...
init_vue_runtime_esm_bundler();
function a5(a10, h5, g4, o7, c13, d4) {
  return openBlock(), createBlock("span", { class: g4.suit() }, [(openBlock(true), createBlock(Fragment, null, renderList(d4.parsedHighlights, function(i4, s6) {
...
init_vue_runtime_esm_bundler();
function c6(c13, a10, m6, f8, d4, v5) {
...
init_vue_runtime_esm_bundler();
function c7(c13, f8, d4, h5, v5, p5) {
...
var _excluded6 = ["initialSearchParameters"];
...
function _objectSpread33(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys33(Object(source), true).forEach(function(key) {
...
function getLocalWidgetsSearchParameters(widgets, widgetSearchParametersOptions) {
  var initialSearchParameters = widgetSearchParametersOptions.initialSearchParameters, rest = _objectWithoutProperties6(widgetSearchParametersOptions, _excluded6);
...
var index = function index2(widgetParams) {
  ...
  return {
    ...
    createURL: function createURL(nextState) {
      return localInstantSearchInstance._createURL(_defineProperty34({}, indexId, getLocalWidgetsUiState(localWidgets, {
    ...
    getWidgetUiState: function getWidgetUiState(uiState) {
      ...
      }, _objectSpread33(_objectSpread33({}, uiState), {}, _defineProperty34({}, indexId, _objectSpread33(_objectSpread33({}, uiState[indexId]), localUiState))));
    },
...
function storeRenderState(_ref7) {
  ...
  instantSearchInstance.renderState = _objectSpread33(_objectSpread33({}, instantSearchInstance.renderState), {}, _defineProperty34({}, parentIndexName, _objectSpread33(_objectSpread33({}, instantSearchInstance.renderState[parentIndexName]), renderState)));
}
...
function getCookie(name) {
  if ((typeof document === "undefined" ? "undefined" : _typeof39(document)) !== "object" || typeof document.cookie !== "string") {
    return void 0;
  }
...
function _objectSpread34(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys34(Object(source), true).forEach(function(key) {
  ...
  return {
    ...
    highlight: function highlight2(options, render) {
      try {
        ...
        return render(highlight(_objectSpread34(_objectSpread34({}, highlightOptions), {}, {
          hit: this
        })));
      } catch (error) {
    ...
    reverseHighlight: function reverseHighlight2(options, render) {
      try {
        ...
        return render(reverseHighlight(_objectSpread34(_objectSpread34({}, reverseHighlightOptions), {}, {
          hit: this
        })));
      } catch (error) {
    ...
    snippet: function snippet2(options, render) {
      try {
        ...
        return render(snippet(_objectSpread34(_objectSpread34({}, snippetOptions), {}, {
          hit: this
        })));
      } catch (error) {
    ...
    reverseSnippet: function reverseSnippet2(options, render) {
      try {
        ...
        return render(reverseSnippet(_objectSpread34(_objectSpread34({}, reverseSnippetOptions), {}, {
          hit: this
        })));
      } catch (error) {
    ...
    insights: function insights2(options, render) {
      try {
        ...
        return render(insights(method, _objectSpread34({
...
function _objectSpread35(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys35(Object(source), true).forEach(function(key) {
...
function getIndexStateWithoutConfigure(uiState) {
  var configure = uiState.configure, trackedUiState = _objectWithoutProperties7(uiState, _excluded7);
  ...
  return {
    stateToRoute: function stateToRoute(uiState) {
      return Object.keys(uiState).reduce(function(state, indexId) {
        return _objectSpread35(_objectSpread35({}, state), {}, _defineProperty36({}, indexId, getIndexStateWithoutConfigure(uiState[indexId])));
      }, {});
    },
    routeToState: function routeToState() {
      var routeState = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return Object.keys(routeState).reduce(function(state, indexId) {
        return _objectSpread35(_objectSpread35({}, state), {}, _defineProperty36({}, indexId, getIndexStateWithoutConfigure(routeState[indexId])));
      }, {});
    }
  };
}
...
var BrowserHistory = function() {
  function BrowserHistory2(_ref) {
    ...
    _defineProperty37(this, "windowTitle", void 0);
    _defineProperty37(this, "writeDelay", void 0);
    _defineProperty37(this, "_createURL", void 0);
    _defineProperty37(this, "parseURL", void 0);
    _defineProperty37(this, "getLocation", void 0);
    _defineProperty37(this, "writeTimer", void 0);
    _defineProperty37(this, "inPopState", false);
    _defineProperty37(this, "isDisposed", false);
    _defineProperty37(this, "latestAcknowledgedHistory", 0);
    _defineProperty37(this, "_start", void 0);
    _defineProperty37(this, "_dispose", void 0);
    _defineProperty37(this, "_push", void 0);
...
function _objectSpread36(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys36(Object(source), true).forEach(function(key) {
  ...
  return function(_ref) {
    ...
    function topLevelCreateURL(nextState) {
      var uiState = Object.keys(nextState).reduce(function(acc, indexId) {
        return _objectSpread36(_objectSpread36({}, acc), {}, _defineProperty38({}, indexId, nextState[indexId]));
    ...
    return {
      ...
      subscribe: function subscribe() {
        instantSearchInstance._initialUiState = _objectSpread36(_objectSpread36({}, initialUiState), stateMapping.routeToState(router.read()));
...
function _objectSpread37(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys37(Object(source), true).forEach(function(key) {
...
function _setPrototypeOf(o7, p5) {
  _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o8, p6) {
    o8.__proto__ = p6;
    return o8;
  };
...
function _getPrototypeOf(o7) {
  _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf2(o8) {
...
var InstantSearch = function(_EventEmitter) {
  ...
  function InstantSearch2(options) {
    ...
    _defineProperty39(_assertThisInitialized(_this), "client", void 0);
    _defineProperty39(_assertThisInitialized(_this), "indexName", void 0);
    _defineProperty39(_assertThisInitialized(_this), "insightsClient", void 0);
    _defineProperty39(_assertThisInitialized(_this), "onStateChange", null);
    _defineProperty39(_assertThisInitialized(_this), "helper", void 0);
    _defineProperty39(_assertThisInitialized(_this), "mainHelper", void 0);
    _defineProperty39(_assertThisInitialized(_this), "mainIndex", void 0);
    _defineProperty39(_assertThisInitialized(_this), "started", void 0);
    _defineProperty39(_assertThisInitialized(_this), "templatesConfig", void 0);
    _defineProperty39(_assertThisInitialized(_this), "renderState", {});
    _defineProperty39(_assertThisInitialized(_this), "_stalledSearchDelay", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_searchStalledTimer", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_initialUiState", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_initialResults", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_createURL", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_searchFunction", void 0);
    _defineProperty39(_assertThisInitialized(_this), "_mainHelperSearch", void 0);
    _defineProperty39(_assertThisInitialized(_this), "middleware", []);
    _defineProperty39(_assertThisInitialized(_this), "sendEventToInsights", void 0);
    _defineProperty39(_assertThisInitialized(_this), "status", "idle");
    _defineProperty39(_assertThisInitialized(_this), "error", void 0);
    _defineProperty39(_assertThisInitialized(_this), "scheduleSearch", defer(function() {
      if (_this.started) {
        _this.mainHelper.search();
      }
    }));
    _defineProperty39(_assertThisInitialized(_this), "scheduleRender", defer(function() {
    ...
    _defineProperty39(_assertThisInitialized(_this), "onInternalStateChange", defer(function() {
  ...
  _createClass3(InstantSearch2, [{
    ...
    value: function use() {
      ...
      var newMiddlewareList = middleware.map(function(fn) {
        var newMiddleware = _objectSpread37({
          subscribe: noop,
          started: noop,
          unsubscribe: noop,
          onStateChange: noop
...
function getStateWithoutPage2(state) {
  var _ref = state || {}, page = _ref.page, rest = _objectWithoutProperties8(_ref, _excluded8);
  return rest;
}
...
init_vue_runtime_esm_bundler();
function l2(l7, f8, d4, P2, c13, g4) {
  return l7.state ? (openBlock(), createBlock("div", { key: 0, class: l7.suit() }, [d4.showPrevious ? renderSlot(l7.$slots, "loadPrevious", { key: 0, refinePrevious: g4.refinePrevious, page: l7.state.results.page, isFirstPage: l7.state.isFirstPage }, function() {
...
function c9(c13, f8, v5, d4, m6, p5) {
...
init_vue_runtime_esm_bundler();
function c10(c13, r15, f8, o7, d4, m6) {
...
function f6(f8, l7, o7, g4, P2, L2) {
  return f8.state ? (openBlock(), createBlock("div", { key: 0, class: f8.suit() }, [renderSlot(f8.$slots, "default", { refine: L2.refine, createURL: f8.state.createURL, currentRefinement: f8.state.currentRefinement, nbHits: f8.state.nbHits, nbPages: f8.state.nbPages, pages: f8.state.pages, isFirstPage: f8.state.isFirstPage, isLastPage: f8.state.isLastPage }, function() {
    ...
    })], 2)) : createCommentVNode("v-if", true), o7.showPrevious ? (openBlock(), createBlock("li", { key: 1, class: (P3 = {}, P3[f8.suit("item")] = true, P3[f8.suit("item", "previousPage")] = true, P3[f8.suit("item", "disabled")] = f8.state.isFirstPage, P3) }, [renderSlot(f8.$slots, "previous", { createURL: function() {
...
var d2 = createVNode("use", { "xlink:href": "#ais-RatingMenu-starEmptySymbol" }, null, -1);
var f7 = createTextVNode("& Up");
function m5(o7, m6, p5, v5, y3, g4) {
  return o7.state ? (openBlock(), createBlock("div", { key: 0, class: o7.suit() }, [renderSlot(o7.$slots, "default", { items: o7.state.items, refine: o7.state.refine, createURL: o7.state.createURL, sendEvent: o7.state.sendEvent }, function() {
    return [c11, createVNode("ul", { class: o7.suit("list") }, [(openBlock(true), createBlock(Fragment, null, renderList(o7.state.items, function(r15, c13) {
      return openBlock(), createBlock("li", { key: c13, class: [o7.suit("item"), r15.isRefined && o7.suit("item", "selected")] }, [createVNode("a", { href: o7.state.createURL(r15.value), "aria-label": r15.value + " & Up", class: o7.suit("link"), onClick: withModifiers(function(t6) {
        ...
        return openBlock(), createBlock(Fragment, null, [s6 ? (openBlock(), createBlock("svg", { "aria-hidden": "true", width: "24", height: "24", class: [o7.suit("starIcon"), o7.suit("starIcon--full")], key: i4 + "-full" }, [h4], 2)) : (openBlock(), createBlock("svg", { class: [o7.suit("starIcon"), o7.suit("starIcon--empty")], "aria-hidden": "true", width: "24", height: "24", key: i4 + "-empty" }, [d2], 2))], 64);
...
init_vue_runtime_esm_bundler();
function u5(u10, h5, f8, g4, m6, d4) {
  var v5 = resolveComponent("search-input"), w2 = resolveComponent("ais-highlight");
  return u10.state ? (openBlock(), createBlock("div", { key: 0, class: [u10.suit(), !u10.state.canRefine && u10.suit("", "noRefinement")] }, [renderSlot(u10.$slots, "default", { items: d4.items, refine: d4.refine, searchForItems: u10.state.searchForItems, searchForItemsQuery: m6.searchForFacetValuesQuery, toggleShowMore: d4.toggleShowMore, canToggleShowMore: u10.state.canToggleShowMore, isShowingMore: u10.state.isShowingMore, createURL: u10.state.createURL, isFromSearch: u10.state.isFromSearch, canRefine: u10.state.canRefine, sendEvent: u10.state.sendEvent }, function() {
    var e7;
    return [f8.searchable ? (openBlock(), createBlock("div", { key: 0, class: u10.suit("searchBox") }, [createVNode(v5, { modelValue: d4.searchForFacetValues, "onUpdate:modelValue": h5[1] || (h5[1] = function(e8) {
      return d4.searchForFacetValues = e8;
    }), placeholder: f8.searchablePlaceholder, "class-names": u10.classNames }, null, 8, ["modelValue", "placeholder", "class-names"])], 2)) : createCommentVNode("v-if", true), u10.state.isFromSearch && 0 === d4.items.length ? renderSlot(u10.$slots, "noResults", { key: 1, query: d4.searchForFacetValues }, function() {
      return [createVNode("div", { class: u10.suit("noResults") }, "No results.", 2)];
    }) : createCommentVNode("v-if", true), createVNode("ul", { class: u10.suit("list") }, [(openBlock(true), createBlock(Fragment, null, renderList(d4.items, function(e8) {
      return openBlock(), createBlock("li", { class: [u10.suit("item"), e8.isRefined && u10.suit("item", "selected")], key: e8.value }, [renderSlot(u10.$slots, "item", { item: e8, refine: d4.refine, createURL: u10.state.createURL }, function() {
      ...
      for (var e8 = [], s6 = arguments.length; s6--; )
        e8[s6] = arguments[s6];
      return d4.toggleShowMore && d4.toggleShowMore.apply(d4, e8);
...
function r11(r15, i4, c13, f8, p5, d4) {
  return r15.state && r15.state.state && r15.state.results ? (openBlock(), createBlock("div", { key: 0, class: r15.suit() }, [renderSlot(r15.$slots, "default", d4.stateResults, function() {
...
init_vue_runtime_esm_bundler();
function a8(a10, l7, c13, d4, f8, m6) {
...
init_vue_runtime_esm_bundler();
function u7(u10, c13, S2, f8, d4, g4) {
...
var d3 = createVNode("line", { x1: "12", y1: "19", x2: "12", y2: "23" }, null, -1);
var p4 = createVNode("line", { x1: "8", y1: "23", x2: "16", y2: "23" }, null, -1);
var v4 = createVNode("path", { d: "M19 10v2a7 7 0 0 1-14 0v-2" }, null, -1);
var y2 = createVNode("line", { x1: "12", y1: "19", x2: "12", y2: "23" }, null, -1);
var c12 = createVNode("line", { x1: "8", y1: "23", x2: "16", y2: "23" }, null, -1);
function x2(x3, f8, b2, S2, g4, h5) {
  return x3.state ? (openBlock(), createBlock("div", { key: 0, class: x3.suit() }, [renderSlot(x3.$slots, "default", h5.rootSlotProps, function() {
    return [createVNode("button", { type: "button", class: x3.suit("button"), title: x3.state.isBrowserSupported ? b2.buttonTitle : b2.disabledButtonTitle, disabled: !x3.state.isBrowserSupported, onClick: f8[1] || (f8[1] = function() {
      for (var t6 = [], l7 = arguments.length; l7--; )
        t6[l7] = arguments[l7];
      return h5.handleClick && h5.handleClick.apply(h5, t6);
    }) }, [renderSlot(x3.$slots, "buttonText", h5.innerSlotProps, function() {
      return [h5.errorNotAllowed ? (openBlock(), createBlock("svg", mergeProps({ key: 0 }, g4.buttonSvgAttrs), [r13, u9, a9, d3, p4], 16)) : (openBlock(), createBlock("svg", mergeProps({ key: 1 }, g4.buttonSvgAttrs), [createVNode("path", { d: "M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z", fill: x3.state.isListening ? "currentColor" : "none" }, null, 8, ["fill"]), v4, y2, c12], 16))];
    })], 10, ["title", "disabled"]), createVNode("div", { class: x3.suit("status") }, [renderSlot(x3.$slots, "status", h5.innerSlotProps, function() {
      return [createVNode("p", null, toDisplayString(x3.state.voiceListeningState.transcript), 1)];
    })], 2)];
  })], 2)) : createCommentVNode("v-if", true);
}

// node_modules/vue-instantsearch/vue3/es/src/components/VoiceSearch.vue.js
VoiceSearch_vue_vue_type_script_lang_default.render = x2, VoiceSearch_vue_vue_type_script_lang_default.__file = "src/components/VoiceSearch.vue";
...
init_vue_runtime_esm_bundler();
function l6(l7, o7, u10, v5, d4, f8) {
